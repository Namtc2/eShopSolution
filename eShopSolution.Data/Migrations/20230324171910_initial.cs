        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2023, 3, 25, 0, 19, 10, 742, DateTimeKind.Local).AddTicks(4018)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 3, 25, 0, 19, 10, 751, DateTimeKind.Local).AddTicks(9802), 100000m, 200000m });
